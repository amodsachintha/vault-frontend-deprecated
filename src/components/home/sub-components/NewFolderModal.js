...
import Folder from "../../../main/collections/models/Folder";
...
class NewFolderModal extends Component {
    ...
    handleCreateClick = () => {
        ...
        if (this.state.folderName.trim() === "") {
            ...
            this.props.handleCreateNewFolder(new Folder(this.state.folderName.trim(), new Date()));
            this.closeModal();
        }
    };
    ...
    render() {
        return (
            <Modal trigger={<Button onClick={this.openModal} size='tiny' fluid><Icon name='plus'/></Button>}
                   size='small' dimmer='blurring' open={this.state.modalOpen}>
                    ...
                    <Form>
                        <Form.Field>
                            ...
                            {!this.state.validName ?
                                <Label basic color='red' pointing>Please enter a folder name!</Label> : ''}
                        </Form.Field>
                    </Form>
                </Modal.Content>
                <Modal.Actions>
